    ...
    <article className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-panel">
      <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            <p className="text-sm font-semibold text-slate-900">확인할 것</p>
      ...
      {open ? (
        <dl className="mt-5 grid gap-4 border-t border-slate-200 pt-5 text-sm leading-7 text-slate-700">
          <div>
            <dt className="font-semibold text-slate-900">이 항목이 나온 이유</dt>
            <dd>{item.reason}</dd>
          </div>
          <div>
          ...
          <div>
            <dt className="font-semibold text-slate-900">자세한 확인 사항</dt>
            <dd>
              <ul className="grid gap-2">
          ...
          <div>
            <dt className="font-semibold text-slate-900">공식 사이트 검색 키워드</dt>
            <dd>
